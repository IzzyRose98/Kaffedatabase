...
cursor.execute('CREATE TABLE Kaffesmaking (KaffesmakingID INTEGER PRIMARY KEY NOT NULL UNIQUE, Notat TEXT, Poeng INTEGER, Smaksdato INTEGER, FerdigbrentKaffeID INTEGER NOT NULL, Epost TEXT, BrenneriID INTEGER NOT NULL, FOREIGN KEY(FerdigbrentKaffeID) REFERENCES FerdigbrentKaffe(FerdigbrentKaffeID), FOREIGN KEY(Epost) REFERENCES Bruker(Epost), FOREIGN KEY (BrenneriID) REFERENCES Brenneri(BrenneriID))')
